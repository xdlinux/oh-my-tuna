...
class Debian(Base):
    ...
    @classmethod
    def up(cls):
        print('This operation will move your current sources.list to sources.oh-my-xdlinux.bak.list,\n' + \
    ...
    @classmethod
    def down(cls):
        print('This operation will copy sources.oh-my-xdlinux.bak.list to sources.list if there is one,\n' + \
